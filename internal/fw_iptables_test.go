...
func TestIPTables_IPv4RuleAddAndRemove2(t *testing.T) {
	c := &CommandExecuteMock{}
	ipt := NewIPTables(c, IPTablesSettingsDefault)
...
func TestIPTables_IPv4RuleAddAndRemove3(t *testing.T) {
	c := &CommandExecuteMock{}
	ipt := NewIPTables(c, IPTablesSettingsDefault)
	...
	c.On("Execute", "conntrack", []byte(nil), []string{
		...
		"-s", "88.200.23.12",
		"-d", "88.200.23.3",
		"--dport", "443:1000"}).Return([]byte{}, nil).Once()
...
func TestIPTables_IPv6RuleAddAndRemove2(t *testing.T) {
	c := &CommandExecuteMock{}
	ipt := NewIPTables(c, IPTablesSettingsDefault)
...
func TestIPTables_IPv6RuleAddAndRemove3(t *testing.T) {
	c := &CommandExecuteMock{}
	ipt := NewIPTables(c, IPTablesSettingsDefault)
