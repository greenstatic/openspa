...
import (
	...
	"github.com/greenstatic/openspa/openspa/internal/client"
	"github.com/greenstatic/openspa/openspa/internal/ipresolver"
	"github.com/greenstatic/openspa/openspa/internal/ospa"
...
func request(clientPrivKey *rsa.PrivateKey, clientPubKey *rsa.PublicKey, serverPubKey *rsa.PublicKey, protocol byte, ch chan string) {
	...
	for {
		if clientIPSetManually {
			log.Infof("Using manual client IP: %s with NAT flag set to: %s", clientIP.String(),
